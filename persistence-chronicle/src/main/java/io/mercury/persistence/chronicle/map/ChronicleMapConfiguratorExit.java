...
@Immutable
public final class ChronicleMapConfiguratorExit<K, V> implements Configurator {
	...
	private ChronicleMapConfiguratorExit(Builder<K, V> builder) {
	...
	public static class Builder<K, V> {
		...
		public ChronicleMapConfiguratorExit<K, V> build() {
			return new ChronicleMapConfiguratorExit<>(this);
		}
	}
